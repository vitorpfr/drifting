...
| Accessibility / screen reader support | 🚧 Next — ARIA labels on all controls, `aria-live` region for station changes, focus management in modals, alt text on favicons; keyboard nav already in place as foundation |
